...
export function SettingsScreen({ tenantContext, productCount, saleCount, pendingCount, resetDemo }: SettingsScreenProps) {
    ...
    <section className="screen settings-screen">
      ...
      <section className="panel account-panel">
        ...
        <div>
          ...
          <p>{tenantContext.user.email ?? "Usuario autenticado"} · Catálogo sincronizado con Supabase.</p>
        </div>
      </section>
      <section className="settings-list">
        ...
        <SettingsItem icon={<RotateCcw size={21} />} label="Ventas locales pendientes" value={String(pendingCount)} />
